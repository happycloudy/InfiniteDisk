...
var FilesController = /** @class */ (function () {
    ...
    FilesController.prototype.getAll = function () {
        return this.filesService.getAll();
    };
    FilesController.prototype.getFile = function (file) {
        return this.filesService.getFile(file);
    };
    __decorate([
        (0, common_1.Get)()
    ], FilesController.prototype, "getAll");
    __decorate([
        (0, common_1.Post)('/download'),
        __param(0, (0, common_1.Body)())
    ], FilesController.prototype, "getFile");
